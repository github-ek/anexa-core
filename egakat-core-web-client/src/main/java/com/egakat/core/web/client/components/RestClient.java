...
public interface RestClient {
	...
	<T> ResponseEntity<T> post(String resourcePath, HttpHeaders headers, Object model, Class<T> responseType,
			Object... uriVariables);

	<T> ResponseEntity<T> put(String resourcePath, Object model, Class<T> responseType, Object... uriVariables);

	<T> ResponseEntity<T> put(String resourcePath, HttpHeaders headers, Object model, Class<T> responseType,
			Object... uriVariables);

	<T> ResponseEntity<T> patch(String resourcePath, Object model, Class<T> responseType, Object... uriVariables);

	<T> ResponseEntity<T> patch(String resourcePath, HttpHeaders headers, Object model, Class<T> responseType,
			Object... uriVariables);
